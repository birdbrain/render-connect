...
class LBN_Settings {
	...
	public function create_admin_page() {
		...
		?>
		<div class="wrap">
			<h1>Render Connect Settings</h1>
			<form method="post" action="options.php">
			<?php
				// This prints out all hidden setting fields.
				settings_fields( 'build_group' );
				do_settings_sections( 'render' );
				submit_button();
			?>
			</form>
		</div>
	...
	public function prod_callback() {
		printf(
			'<input type="text" id="prod_buildhook" name="lb_render[production_buildhook]" value="%s" style="min-width:450px;"/>',
	...
	public function prod_url_callback() {
		printf(
			'<input type="text" id="production_url" name="lb_render[production_url]" value="%s" style="min-width:450px;"/>',
	...
	public function stage_callback() {
		printf(
			'<input type="text" id="stage_buildhook" name="lb_render[stage_buildhook]" value="%s" style="min-width:450px;" />',
	...
	public function stage_url_callback() {
		printf(
			'<input type="text" id="stage_url" name="lb_render[stage_url]" value="%s" style="min-width:450px;" />',
	...
	public function staging_build_status_badge_url_callback() {
		printf(
			'<input type="text" id="staging_build_status_badge_url" name="lb_render[staging_build_status_badge_url]" value="%s" style="min-width:450px;" />',
	...
	public function production_build_status_badge_url_callback() {
		printf(
			'<input type="text" id="production_build_status_badge_url" name="lb_render[production_build_status_badge_url]" value="%s" style="min-width:450px;" />',
